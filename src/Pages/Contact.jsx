  ...
  return (
    ...
    <NavBar />
      <div className="w-full relative overflow-hidden">
        <div
          className="h-[38rem] w-full flex flex-col justify-center items-center bg-cover bg-center  relative"
        ...
        <div className="w-full flex justify-center bg-gray-200">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 p-10 py-20 w-full max-w-7xl">
            <div className="flex items-start        p-10 justify-start hover:border-2 hover:border-gray-800 bg-gray-400 h-[18rem] rounded-2xl border-2 text-white">
            ...
            <div className="flex hover:border-2 hover:border-gray-800 p-10 items-start justify-start bg-gray-600 h-[18rem]  rounded-2xl border-2 text-white">
              <div className="flex gap-3 flex-col ">
            ...
            <div className="flex items-start justify-start p-10 hover:border-2 hover:border-gray-800 bg-gray-400 h-[18rem] rounded-2xl border-2 text-white">
              <div className="flex gap-3 flex-col">
